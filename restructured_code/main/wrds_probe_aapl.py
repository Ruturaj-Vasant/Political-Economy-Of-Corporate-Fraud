"""
Probe WRDS for ticker-based identifiers and attributes using AAPL as example.

Queries:
- crsp.stocknames: permno, names, ncusip
- crsp.ccmxpf_linktable: gvkey via permno
- comp.company: gvkey by ticker (fallback)
- crsp.dsf: latest exchcd via permno
- crsp.msedelist: delisting info
- comp.funda: latest currency (curcd) for INDL/STD/D/C
- comp_execucomp.anncomp: descriptions and location
"""
